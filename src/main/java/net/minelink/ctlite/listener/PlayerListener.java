...
import net.minelink.ctlite.event.PlayerCombatTagEvent;
...
public final class PlayerListener implements Listener {
    ...
    public PlayerListener(CombatTagLite plugin) {
        this.plugin = plugin;
    }
    ...
    public void broadcastKill(PlayerDeathEvent event) {
        ...
        Bukkit.broadcast(message, "ctlite.notify.kill");
    }
    ...
    public void disableCommand(PlayerCommandPreprocessEvent event) {
        ...
        Player player = event.getPlayer();
        if (player.hasPermission("ctlite.bypass.command")) return;
    ...
    public void disableBlockEdit(BlockBreakEvent event) {
        ...
        // Do nothing if player has bypass permission
        Player player = event.getPlayer();
        if (player.hasPermission("ctlite.bypass.blockedit")) return;
    ...
    private boolean tryDisableStorageAccess(Player player, InventoryView view) {
        // Do nothing if storage access is allowed in combat
    ...
    public void disableEnderpearls(PlayerInteractEvent event) {
        ...
        // Do nothing if player has bypass permission
        Player player = event.getPlayer();
        if (player.hasPermission("ctlite.bypass.enderpearl")) return;
    ...
    public void disableFlying(PlayerCombatTagEvent event) {
        ...
        p = event.getVictim();
        if (p != null && p.isFlying() && !p.hasPermission("ctlite.bypass.flying")) {
    ...
    public void disableFlying(PlayerToggleFlightEvent event) {
        ...
        // Do nothing if player has bypass permission
        if (player.hasPermission("ctlite.bypass.flying")) return;
    ...
    public void disableTeleportation(PlayerTeleportEvent event) {
        ...
        // Do nothing if player has bypass permission
        if (player.hasPermission("ctlite.bypass.teleport")) return;
    ...
    public void disableCrafting(CraftItemEvent event) {
        ...
        // Do nothing if player has bypass permission
        if (player.hasPermission("ctlite.bypass.craft")) return;
    ...
    public void PlayerLogout(PlayerQuitEvent event) {
        ...
        // Do nothing if player has permission
        if (player.hasPermission("ctlite.bypass.tag")) return;
